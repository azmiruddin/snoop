...
contract EndpointRegistryContract {
     ...
     */
    function registerEndpoint(string memory socket) public noEmptyString(socket)
    {
     ...
     */
    function findEndpointByAddress(address eth_address) public view returns (string memory socket)
    {
        return address_to_socket[eth_address];
    }

    function equals(string memory a, string memory b) internal view returns (bool result)
    {
