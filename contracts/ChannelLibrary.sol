...
library ChannelLibrary {
    ...
    returns (bool success, uint256 balance)
    {
        ...
        ERC20Standard token = self.manager.token();
    ...
    function settle(Data storage self) public
    ...
    function audit(Data storage self, address auditor) public
