...
public class EndpointRegistryContract extends Contract {
    ...
    public Future<Utf8String> findEndpointByAddress2(Address eth_address) throws IOException {
        Function function = new Function(FUNC_FINDENDPOINTBYADDRESS, 
                Arrays.<Type>asList(eth_address), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Utf8String>() {}));
...
//    }
    ...
    public String findEndpointByAddressString(String eth_address) throws IOException {
        final Function function = new Function(FUNC_FINDENDPOINTBYADDRESS, 
                Arrays.<Type>asList(new org.web3j.abi.datatypes.Address(160, eth_address)), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Utf8String>() {}));
        return executeCallSingleValueReturn(function);
...
//  Operation from Web3j 2.3.0
	public Future<Utf8String> findEndpointByAddress(Address eth_address) {
		Function function = new Function("findEndpointByAddress", Arrays.<Type>asList(eth_address),
				Arrays.<TypeReference<?>>asList(new TypeReference<Utf8String>() {
				}));
