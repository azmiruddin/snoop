 ...
 * 
 * Deploy commitment and request channel
 */
...
public class MerkleContract extends Contract {
	...
	@Deprecated
	protected MerkleContract(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice,
			BigInteger gasLimit) {
		super(BINARY, contractAddress, web3j, credentials, gasPrice, gasLimit);
	}

	protected MerkleContract(String contractAddress, Web3j web3j, Credentials credentials,
			ContractGasProvider contractGasProvider) {
		super(BINARY, contractAddress, web3j, credentials, contractGasProvider);
	}

	@Deprecated
	protected MerkleContract(String contractAddress, Web3j web3j, TransactionManager transactionManager,
	...
	public RemoteFunctionCall<String> channelRecipient(String string) {
		final Function function = new Function(FUNC_CHANNELRECIPIENT, Arrays.<Type>asList(),
	...
	public RemoteFunctionCall<String> channelSender(String string) {
		final Function function = new Function(FUNC_CHANNELSENDER, Arrays.<Type>asList(),
				Arrays.<TypeReference<?>>asList(new TypeReference<Address>() {
				}));
		return executeRemoteCallSingleValueReturn(function, String.class);
	}
	...
	public RemoteFunctionCall<BigInteger> startDate() {
		final Function function = new Function(FUNC_STARTDATE, Arrays.<Type>asList(),
	...
	/*
	 * public RemoteFunctionCall<TransactionReceipt> CloseChannel(BigInteger
	 * _amount, List<byte[]> proof) { final Function function = new Function(
	 * FUNC_CLOSECHANNEL, Arrays.<Type>asList(new
	 * org.web3j.abi.datatypes.generated.Uint256(_amount), new
	 * org.web3j.abi.datatypes.DynamicArray<org.web3j.abi.datatypes.generated.
	 * Bytes32>( org.web3j.abi.datatypes.generated.Bytes32.class,
	 * org.web3j.abi.Utils.typeMap(proof,
	 * org.web3j.abi.datatypes.generated.Bytes32.class))),
	 * Collections.<TypeReference<?>>emptyList()); return
	 * executeRemoteCallTransaction(function); }
	 */

	public Future<Uint256> CloseChannel(BigInteger _amount, List<byte[]> proof) {
		final Function function = new Function(FUNC_CLOSECHANNEL,
				Arrays.<Type>asList(new org.web3j.abi.datatypes.generated.Uint256(_amount),
						new org.web3j.abi.datatypes.DynamicArray<org.web3j.abi.datatypes.generated.Bytes32>(
								org.web3j.abi.datatypes.generated.Bytes32.class,
								org.web3j.abi.Utils.typeMap(proof, org.web3j.abi.datatypes.generated.Bytes32.class))),
				Collections.<TypeReference<?>>emptyList());
		return (Future<Uint256>) executeRemoteCallTransaction(function);
	}

	public RemoteFunctionCall<BigInteger> channelTimeout() {
		final Function function = new Function(FUNC_channelTimeout, Arrays.<Type>asList(),
				Arrays.<TypeReference<?>>asList(new TypeReference<Uint256>() {
				}));
		return executeRemoteCallSingleValueReturn(function, BigInteger.class);
	}
	...
	public RemoteFunctionCall<byte[]> roots() {
		final Function function = new Function(FUNC_ROOTS, Arrays.<Type>asList(),
	...
	public static RemoteCall<MerkleContract> deploy(Web3j web3j, Credentials credentials,
			ContractGasProvider contractGasProvider, String _MerkleContract) {
		String encodedConstructor = FunctionEncoder
				.encodeConstructor(Arrays.<Type>asList(new org.web3j.abi.datatypes.Utf8String(_MerkleContract)));
		return deployRemoteCall(MerkleContract.class, web3j, credentials, contractGasProvider, BINARY,
				encodedConstructor);
	}

	public RemoteFunctionCall<String> greet() {
		final Function function = new Function(FUNC_GREET, Arrays.<Type>asList(),
	...
	public RemoteFunctionCall<TransactionReceipt> newGreeting(String _greeting) {
		final Function function = new Function(FUNC_NEWGREETING,
	...
	public List<Object> SeeBalance() {
		return (List<Object>) web3j.ethGetBalance(contractAddress, DefaultBlockParameter.valueOf(contractBinary));
	}

	public Future<Address> ReceiverAddress() {
		return (Future<Address>) web3j.ethAccounts();
	}

	public Future<Address> SenderAddress() {
		return (Future<Address>) web3j.ethAccounts();
	}

	public static class verifyMerkle extends MerkleContract {
		public verifyMerkle(String contractAddress, Web3j web3j, TransactionManager transactionManager,
				ContractGasProvider contractGasProvider) {
		...
		@Override
		public RemoteFunctionCall<Boolean> verifyMerkle(byte[] root, byte[] leaf, List<byte[]> proof) {
			return super.verifyMerkle(root, leaf, proof);
		}
	}

	@Deprecated
	public static MerkleContract load(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice,
			BigInteger gasLimit) {
		return new MerkleContract(contractAddress, web3j, credentials, gasPrice, gasLimit);
	}

	@Deprecated
	public static MerkleContract load(String contractAddress, Web3j web3j, TransactionManager transactionManager,
			BigInteger gasPrice, BigInteger gasLimit) {
		return new MerkleContract(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
	}

	public static MerkleContract load(String contractAddress, Web3j web3j, Credentials credentials,
			ContractGasProvider contractGasProvider) {
	...
	public static RemoteCall<MerkleContract> deploy(Web3j web3j, Credentials credentials,
			ContractGasProvider contractGasProvider, BigInteger initialWeiValue, String to, BigInteger _timeout,
			byte[] _root) {
		String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.<Type>asList(
				new org.web3j.abi.datatypes.Address(160, to), new org.web3j.abi.datatypes.generated.Uint256(_timeout),
				new org.web3j.abi.datatypes.generated.Bytes32(_root)));
		return deployRemoteCall(MerkleContract.class, web3j, credentials, contractGasProvider, BINARY,
				encodedConstructor, initialWeiValue);
	}

	public static RemoteCall<MerkleContract> deploy(Web3j web3j, TransactionManager transactionManager,
			ContractGasProvider contractGasProvider, BigInteger initialWeiValue, String to, BigInteger _timeout,
			byte[] _root) {
		String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.<Type>asList(
				new org.web3j.abi.datatypes.Address(160, to), new org.web3j.abi.datatypes.generated.Uint256(_timeout),
				new org.web3j.abi.datatypes.generated.Bytes32(_root)));
		return deployRemoteCall(MerkleContract.class, web3j, transactionManager, contractGasProvider, BINARY,
				encodedConstructor, initialWeiValue);
	}

	@Deprecated
	public static RemoteCall<MerkleContract> deploy(Web3j web3j, Credentials credentials, BigInteger gasPrice,
			BigInteger gasLimit, BigInteger initialWeiValue, String to, BigInteger _timeout, byte[] _root) {
		String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.<Type>asList(
				new org.web3j.abi.datatypes.Address(160, to), new org.web3j.abi.datatypes.generated.Uint256(_timeout),
				new org.web3j.abi.datatypes.generated.Bytes32(_root)));
		return deployRemoteCall(MerkleContract.class, web3j, credentials, gasPrice, gasLimit, BINARY,
				encodedConstructor, initialWeiValue);
	}

	@Deprecated
	public static RemoteCall<MerkleContract> deploy(Web3j web3j, TransactionManager transactionManager,
			BigInteger gasPrice, BigInteger gasLimit, BigInteger initialWeiValue, String to, BigInteger _timeout,
			byte[] _root) {
		String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.<Type>asList(
				new org.web3j.abi.datatypes.Address(160, to), new org.web3j.abi.datatypes.generated.Uint256(_timeout),
				new org.web3j.abi.datatypes.generated.Bytes32(_root)));
		return deployRemoteCall(MerkleContract.class, web3j, transactionManager, gasPrice, gasLimit, BINARY,
				encodedConstructor, initialWeiValue);
	}
}
