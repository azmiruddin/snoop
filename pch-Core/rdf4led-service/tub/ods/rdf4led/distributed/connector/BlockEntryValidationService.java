...
import tub.ods.rdf4led.distributed.merkle.controller.VerifyMerkleController;
...
public class BlockEntryValidationService implements ValidationService<long[]> {
    ...
    private VerifyMerkleController verifyController ;
...
//            }
    ...
    /*
     * toggle new verification for channel processing
     */
    public VerifyMerkleController getVerifyController() {
