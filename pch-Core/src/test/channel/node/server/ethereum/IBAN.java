...
/**
 * Generate QR code according to officially supported IBAN rules. Currently supported imtoken kcash
 * Reference url https://github.com/ethereum/web3.js/blob/develop/lib/web3/iban.js
 * Can prevent address errors (with two checksums)
*/
...
//		System.out.println(checkDigit);
		...
		System.out.println("IBAN " + validateIBAN(IBAN));
