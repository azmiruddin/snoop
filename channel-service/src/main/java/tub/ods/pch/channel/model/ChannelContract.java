...
//    Extended from Web3J 2.3.0
    ...
    public Future<TransactionReceipt> close(Uint256 nonce, Uint256 completed_transfers, DynamicBytes signature) {
        Function function = new Function("close", Arrays.<Type>asList(nonce, completed_transfers, signature), Collections.<TypeReference<?>>emptyList());
        return executeTransactionAsync(function);
    }
