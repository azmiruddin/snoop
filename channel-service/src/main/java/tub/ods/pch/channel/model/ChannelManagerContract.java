...
public class ChannelManagerContract extends Contract {
    ...
    public Address token2() throws IOException {
    ...
    public CompletableFuture<TransactionReceipt> newChannel(Address client, Address receiver, Uint256 close_timeout,
			Uint256 settle_timeout, Uint256 audit_timeout, Address auditor) {
		Function function = new Function("newChannel",
				Arrays.<Type>asList(client, receiver, close_timeout, settle_timeout, audit_timeout, auditor),
				Collections.<TypeReference<?>>emptyList());
	...
	public Future<TransactionReceipt> auditReport(Address contract_address, Uint256 total, Uint256 fraud) {
		Function function = new Function("auditReport", Arrays.<Type>asList(contract_address, total, fraud),
				Collections.<TypeReference<?>>emptyList());
		return (Future<TransactionReceipt>) executeTransactionAsync(function);
	}

	public CompletableFuture<TransactionReceipt> destroyChannel(Address channel_address) {
		Function function = new Function("destroyChannel", Arrays.<Type>asList(channel_address), Collections.<TypeReference<?>>emptyList());
        return executeTransactionAsync(function);
	}
}
